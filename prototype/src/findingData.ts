...
export const findingItems: (FindingMasterItemData & { actorType: string; context: string })[] = [
  { id: "FND-1042", entity: "D. Marek", actorType: "Employee · Finance", context: "4 linked events", timestamp: "Tue 09:12", title: "Payroll transfers to an unregistered personal beneficiary", verdict: "Fraudulent", confidence: "91% confidence", status: "Open" },
